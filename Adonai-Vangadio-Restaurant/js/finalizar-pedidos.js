...
(function () {
    ...
    function validarFormulario() {
        ...
        if (
            !paymentReference.files ||
            !paymentReference.files.length
        ) {

            alert(
                "Carregue uma imagem do comprovativo do pagamento."
            );
        ...
        const comprovativo =
            paymentReference.files[0];


        if (
            !comprovativo.type.startsWith(
                "image/"
            )
        ) {

            alert(
                "Selecione apenas um ficheiro de imagem."
            );
    ...
    if (newOrderButton) {
        ...
        newOrderButton.addEventListener(
            ...
            function () {
                ...
                /*
                 * Limpa completamente os dados
                 * temporários do pedido anterior.
                 */
                ...
                // Observações escritas pelo cliente
                localStorage.removeItem(
                ...
                // Dados auxiliares da finalização
                localStorage.removeItem(
